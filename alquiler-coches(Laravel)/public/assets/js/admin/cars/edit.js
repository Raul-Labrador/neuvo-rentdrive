...
// SERVICE TAGS
let serviceTags = [];
if (window.__oldFeatures !== null && Array.isArray(window.__oldFeatures)) {
	serviceTags = window.__oldFeatures.filter(Boolean);
} else if (Array.isArray(window.__carFeatures)) {
	serviceTags = window.__carFeatures.filter(Boolean);
}
